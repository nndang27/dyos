...
import { CellManager, CellType } from "./CellManager.js";
...
export const NOTEBOOK_TOOLS = [
    ...
    // ==========================================
    {
        ...
        execute: async (args: any) => {
            const cell = cellManager.createCell(args.type as CellType, args.source, args.id);
    ...
    },
    {
        ...
        execute: async (args: any) => {
            ...
            if (!cell) return `Error: Cell ${args.old_id} not found.`;
            cell.id = args.new_id;
    ...
    // ==========================================
    {
        ...
        execute: async (args: any) => {
            ...
            if (!cell) return `Error: Cell ${args.id} not found.`;
            if (cell.cell_type !== "code") return "Cell is not a code cell.";
    ...
    },
    {
        ...
        execute: async (args: any) => {
            const cell = cellManager.getCell(args.id);
            if (!cell) return `Cell ${args.id} not found.`;
